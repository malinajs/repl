...
function ifBlock(label, fn, build, buildElse, parentLabel) {
...
function ifBlockReadOnly(label, fn, build, buildElse) {
  function createBlock(builder) {
...
function $$eachBlock(label, onlyChild, fn, getKey, bind) {
  let eachCD = cd_new();
  cd_attach(eachCD);
